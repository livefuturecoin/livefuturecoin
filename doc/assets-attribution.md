The following is a list of assets used in the livefuturecoin source and their proper attribution.
...
### Info
* Designer: md2k7
* Site: https://livefuturecointalk.org/index.php?topic=15276.0
...
### Info
* Designer: Jonas Schnelli (based on the original livefuturecoin logo from Bitboy)
* License: MIT
